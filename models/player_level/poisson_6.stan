...
model {
    ...
    for (game in 1:num_games) {
        ...
        real log_lambda_h = log_home_skill - log_away_skill;
        real log_lambda_a = -log_lambda_h;
        target += poisson_log_lpmf(home_goals[game] | log_lambda_h + correlation_strength);
        target += poisson_log_lpmf(away_goals[game] | log_lambda_a + correlation_strength);
    }
}
...
generated quantities {
    ...
    for (game in 1:num_games) {
        ...
        real log_lambda_h = log_home_skill - log_away_skill;
        real log_lambda_a = -log_lambda_h;
        log_lik += poisson_log_lpmf(home_goals[game] | log_lambda_h + correlation_strength);
        log_lik += poisson_log_lpmf(away_goals[game] | log_lambda_a + correlation_strength);
    }
}
