...
model {
    ...
    for (game in 1:num_games) {
        real log_lambda_team1 = alpha[team1[game]] + nu - alpha[team2[game]] + correlation_strength;
        real log_lambda_team2 = alpha[team2[game]] - alpha[team1[game]] + correlation_strength;
