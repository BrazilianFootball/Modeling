...
model {
    ...
    for (game in 1:num_games) {
        real log_lambda_team1 = sum(alpha[team1_players[game]]) - sum(alpha[team2_players[game]]) + nu;
        real log_lambda_team2 = sum(alpha[team2_players[game]]) - sum(alpha[team1_players[game]]);
